...
function afspraakUpdate(id) {
    ...
    $.ajax({
        type: "GET",
        url: site_url + "/IspVerantwoordelijke/afspraakUpdate/",
        data: {
            'id': id,
            'plaats': plaats,
            'datum': datum,
...
function afspraakEmpty(id) {
    $.ajax({
        type: "GET",
        url: site_url + "/IspVerantwoordelijke/afspraakEmpty/",
        data: {
            'id': id,
        },
        success: function () {
...
function afspraakVerwijder(id) {
    $.ajax({
        type: "GET",
        url: site_url + "/IspVerantwoordelijke/afspraakVerwijder/",
        data: {
            'id': id,
        },
        success: function () {
...
function momentToevoegen() {
    ...
    $.ajax({
        type: "GET",
        url: site_url + "/IspVerantwoordelijke/momentToevoegen/",
        data: {
            'plaats': plaats,
            'datum': datum,
            'start': start,
...
function getAfsprakenByDocent() {
    $.ajax({
        type: "GET",
        url: site_url + "/IspVerantwoordelijke/haalAjaxOp_AfsprakenDocent/",
        success: function (output) {
