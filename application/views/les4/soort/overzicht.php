<script>
    ...
    function controleerSoortEnVraagBevestiging(soortId) {
        $.ajax({
            ...
            success: function (soort) {
                ...
                //om later te kunnen "doorgeven" aan functie schrapSoort()
    ...
    function haalSoortOp(soortId) {
        $.ajax({
            type: "GET",
            url: site_url + "/soort/haalJsonOp_Soort",
            data: {soortId: soortId},
            success: function (soort) {
    ...
    //Daarna wordt de aangepaste lijst biersoorten getoond via een oproep van de jQuery-functie haalSoortenOp()
    //Deze functie wordt opgeroepen nadat er in het modal venster '#modalBevestiging' op 'Ja' is gedrukt.
    function schrapSoort(soortId) {
        $.ajax({
            type: "GET",
            url: site_url + "/soort/schrapAjax_Soort",
            data: {soortId: soortId},
            success: function (result) {
    ...
    $(document).ready(function () {
        ...
        $("#knopJa").click(function () {
            var soortId = $("#soortIdBevestiging").val(); //soortId uit hidden field van modal venster '#modalBevestiging' halen om te kunnen doorgeven aan schrapSoort()
            schrapSoort(soortId);
        });
