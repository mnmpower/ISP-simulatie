<div class="container container90 containerISP">
    <div class="row">
        <div class="container col-4 flex-column d-flex containersISP">
            <div class="flex-grow-1" id="klassenContainer">
                <p>TEST</p>
            </div>
        </div>
        <div class="container col-8 containersISP">
    ...
    <div class="row">
        <div class="container col-4 flex-column d-flex containersISP">
            <div id="fasekeuzeContainer" class="flex-grow-1">
                <p>TEST FASELIJST</p>
            </div>
        </div>
        <div class="container col-6 flex-column d-flex containersISP">
            <div id="vakkenkeuzeContainer" class="flex-grow-1">
                <p>TEST VAKKENLIJST</p>
            </div>
        </div>
